...
/**
 * Clase de Entidad que representa el Modelo de un producto.
 * @author Marcelo Busico.
 */
public class TipoModelo implements InterfazTipoGenerico<TipoModelo>, Normalizable {
    ...
    public TipoModelo(String nombre, String descripcion) {
        this.nombre = nombre;
     ...
     */
    public int compareTo(TipoModelo o) {
