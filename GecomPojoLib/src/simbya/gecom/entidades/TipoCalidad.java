...
/**
 * Clase de Entidad que representa la calidad de un producto.
 * @author Marcelo Busico.
 */
public class TipoCalidad implements InterfazTipoGenerico<TipoCalidad>, Normalizable {
    ...
    public TipoCalidad(String nombre) {
        this.nombre = nombre;
    }

    public TipoCalidad(String nombre, String descripcion) {
        this.nombre = nombre;
     ...
     */
    public int compareTo(TipoCalidad o) {
