 ...
 */
@Remote
public interface GestorActualizarParametrosGeneralesRemote {

    /**
     * Obtiene una lista con todos los parámetros del sistema.
     * @return Lista con parámetros del sistema.
     */
    List<ParametroSistema> getParametros();
     ...
     */
    void actualizarParametros(List<ParametroSistema> parametros) throws Exception;
}
