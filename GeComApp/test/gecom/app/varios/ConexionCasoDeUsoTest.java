 ...
 */
public class ConexionCasoDeUsoTest {

    public ConexionCasoDeUsoTest() {
    }
    ...
    @Test
    public void testConectarYTraerCasosDeUso() {
        ...
        List<CasoDeUso> privilegios = gestor.cargarPrivilegiosDisponibles();
        for (CasoDeUso casoDeUso : privilegios) {
