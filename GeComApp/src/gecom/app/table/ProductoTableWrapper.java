...
/**
 * Envoltorio para los código de producto.
 * @author Marcelo Busico.
 */
public class ProductoTableWrapper {

    private Producto producto;
    private CalidadProducto calidad;

    public ProductoTableWrapper(Producto producto) {
        this.producto = producto;
        calidad = null;
    }

    public ProductoTableWrapper(Producto producto, CalidadProducto calidad) {
        this.producto = producto;
