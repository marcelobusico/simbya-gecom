...
import simbya.gecom.gestores.clientes.GestorActualizarClienteRemote;

/**
 * Ventana para actualizar proveedor.
 * @author Marcelo Busico.
 */
public class VentanaActualizarCliente extends VentanaInterna {

    private GestorActualizarClienteRemote gestor;
    private Cliente seleccion = null;
    private VentanaRegistrarVenta ventanaInvocadora = null;
    private boolean registrado = false;

    /** Crea un nuevo formulario VentanaActualizarCliente */
    ...
    public void enlazarGestorRemoto(GestorConexion gc) throws NamingException {
        gestor = (GestorActualizarClienteRemote) gc.getObjetoRemoto(
                GestorActualizarClienteRemote.class);
    }
    ...
    public void asistirRegistrarNuevoCliente(VentanaRegistrarVenta ventana) {
    ...
    private void tomarSeleccionCliente() {
        if (seleccion == null) {
            return;
        }
    ...
    private boolean verificarDatos() {
        ...
        if ((seleccion.getApellido() == null) || (seleccion.getApellido().isEmpty())) {
            return false;
        }

        if ((seleccion.getNombre() == null) || (seleccion.getNombre().isEmpty())) {
            return false;
        }
        return true;
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(gecom.app.Main.class).getContext().getResourceMap(VentanaActualizarCliente.class);
        ...
        pnlSeleccion.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), resourceMap.getString("pnlSeleccion.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, resourceMap.getFont("Application.font.label"))); // NOI18N
        pnlSeleccion.setName("pnlSeleccion"); // NOI18N

        txtSeleccion.setEditable(false);
        txtSeleccion.setFont(resourceMap.getFont("Application.font.text")); // NOI18N
        ...
        pnlSeleccionLayout.setHorizontalGroup(
            ...
            .addGroup(pnlSeleccionLayout.createSequentialGroup()
                ...
                .addGroup(pnlSeleccionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlSeleccionLayout.createSequentialGroup()
                        .addComponent(txtSeleccion, javax.swing.GroupLayout.DEFAULT_SIZE, 333, Short.MAX_VALUE)
        ...
        pnlDatos.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), resourceMap.getString("pnlDatos.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, resourceMap.getFont("Application.font.label"))); // NOI18N
        pnlDatos.setName("pnlDatos"); // NOI18N

        txtApellido.setEditable(false);
        txtApellido.setFont(resourceMap.getFont("Application.font.text")); // NOI18N
        ...
        lblApellido.setFont(resourceMap.getFont("Application.font.label")); // NOI18N
        ...
        pnlDomicilio.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Domicilio"));
        pnlDomicilio.setName("pnlDomicilio"); // NOI18N

        lblCalle.setFont(resourceMap.getFont("Application.font.label")); // NOI18N
        lblCalle.setText(resourceMap.getString("lblCalle.text")); // NOI18N
        lblCalle.setName("lblCalle"); // NOI18N

        txtCalle.setEditable(false);
        txtCalle.setFont(resourceMap.getFont("Application.font.text")); // NOI18N
        ...
        lblProvincia.setFont(resourceMap.getFont("Application.font.label")); // NOI18N
        lblProvincia.setText(resourceMap.getString("lblProvincia.text")); // NOI18N
        lblProvincia.setName("lblProvincia"); // NOI18N

        cboProvincia.setFont(resourceMap.getFont("Application.font.label")); // NOI18N
        cboProvincia.setEnabled(false);
        ...
        lblLocalidad.setFont(resourceMap.getFont("Application.font.label")); // NOI18N
        lblLocalidad.setText(resourceMap.getString("lblLocalidad.text")); // NOI18N
        lblLocalidad.setName("lblLocalidad"); // NOI18N

        cboLocalidad.setFont(resourceMap.getFont("Application.font.label")); // NOI18N
        cboLocalidad.setEnabled(false);
        ...
        btnQuitarSeleccionProvincia.setText(resourceMap.getString("btnQuitarSeleccionProvincia.text")); // NOI18N
        ...
        pnlDomicilioLayout.setHorizontalGroup(
            ...
            .addGroup(pnlDomicilioLayout.createSequentialGroup()
                ...
                .addGap(17, 17, 17)
                .addGroup(pnlDomicilioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlDomicilioLayout.createSequentialGroup()
                        .addComponent(txtCP, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlDomicilioLayout.createSequentialGroup()
                        .addComponent(txtCalle, javax.swing.GroupLayout.DEFAULT_SIZE, 229, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblNumero)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtNumero, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlDomicilioLayout.createSequentialGroup()
                        .addComponent(cboProvincia, 0, 272, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnQuitarSeleccionProvincia))
                    .addComponent(cboLocalidad, 0, 328, Short.MAX_VALUE))
                .addContainerGap())
        );
                ...
                .addGroup(pnlDomicilioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlDomicilioLayout.createSequentialGroup()
                        .addGroup(pnlDomicilioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(cboProvincia, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlDomicilioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        lblEmail.setFont(resourceMap.getFont("Application.font.label")); // NOI18N
        lblEmail.setText(resourceMap.getString("lblEmail.text")); // NOI18N
        lblEmail.setName("lblEmail"); // NOI18N

        txtEmail.setEditable(false);
        txtEmail.setFont(resourceMap.getFont("Application.font.text")); // NOI18N
        ...
        lblTelefono.setFont(resourceMap.getFont("Application.font.label")); // NOI18N
        lblTelefono.setText(resourceMap.getString("lblTelefono.text")); // NOI18N
        lblTelefono.setName("lblTelefono"); // NOI18N

        txtTelefono.setEditable(false);
        txtTelefono.setFont(resourceMap.getFont("Application.font.text")); // NOI18N
        ...
        lblFax.setFont(resourceMap.getFont("Application.font.label")); // NOI18N
        lblFax.setText(resourceMap.getString("lblFax.text")); // NOI18N
        lblFax.setName("lblFax"); // NOI18N

        txtFax.setEditable(false);
        txtFax.setFont(resourceMap.getFont("Application.font.text")); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlDatosLayout.createSequentialGroup()
                ...
                .addGroup(pnlDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlDatosLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtEmail, javax.swing.GroupLayout.DEFAULT_SIZE, 373, Short.MAX_VALUE)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlDatosLayout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addComponent(lblFax)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtFax, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE))))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlDatosLayout.createSequentialGroup()
                        .addGap(12, 12, 12)
                        .addGroup(pnlDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(pnlDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtApellido, javax.swing.GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE))))
                .addContainerGap())
        );
...
private void txtNombreFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNombreFocusLost
    seleccion.setNombre(TextValidator.validarTexto(this, txtNombre, 2, 50));
}//GEN-LAST:event_txtNombreFocusLost

private void txtApellidoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtApellidoFocusLost
    seleccion.setApellido(TextValidator.validarTexto(this, txtApellido, 2, 50));
...
private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
    seleccion = Buscador.buscarCliente(false);
    tomarSeleccionCliente();
    if (seleccion != null) {
...
private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
    if (ventanaInvocadora != null) {
        if (registrado) {
            ventanaInvocadora.clienteRegistrado(seleccion);
        } else {
            ventanaInvocadora.clienteRegistrado(null);
        }
    }
