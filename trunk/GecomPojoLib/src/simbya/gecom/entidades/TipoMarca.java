...
/**
 * Clase de Entidad que representa una Marca de un Producto.
 * @author Marcelo Busico.
 */
public class TipoMarca implements InterfazTipoGenerico<TipoMarca>, Normalizable {
    ...
    public TipoMarca(String nombre) {
        this.nombre = nombre;
    }

    public TipoMarca(String nombre, String descripcion) {
        this.nombre = nombre;
     ...
     */
    public int compareTo(TipoMarca o) {
