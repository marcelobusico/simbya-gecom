...
/**
 * Clase de Entidad que representa un Rubro de Producto.
 * @author Marcelo Busico.
 */
public class TipoRubro implements InterfazTipoGenerico<TipoRubro>, Normalizable {
    ...
    public TipoRubro(String nombre) {
        this.nombre = nombre;
    }

    public TipoRubro(String nombre, String descripcion) {
        this.nombre = nombre;
     ...
     */
    public int compareTo(TipoRubro o) {
