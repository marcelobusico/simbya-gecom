...
/**
 * Clase de Entidad que representa una unidad de medida.
 * @author Marcelo Busico.
 */
public class TipoUnidadMedida implements InterfazTipoGenerico<TipoUnidadMedida>, Normalizable {
    ...
    public TipoUnidadMedida(String nombre) {
        this.nombre = nombre;
    }

    public TipoUnidadMedida(String nombre, String descripcion) {
        this.nombre = nombre;
    ...
    /**
     * Muestra el nombre de la caliad.
     */
    @Override
     ...
     */
    public int compareTo(TipoUnidadMedida o) {
