...
/**
 * Clase de Entidad que representa una forma de cobro.
 * @author Marcelo Busico.
 */
public class TipoFormaCobro implements InterfazTipoGenerico<TipoFormaCobro>, Normalizable {
    ...
    public TipoFormaCobro(String nombre) {
        this.nombre = nombre;
    }

    public TipoFormaCobro(String nombre, String descripcion) {
        this.nombre = nombre;
    ...
    /**
     * Muestra el nombre de la forma de cobro.
     */
    @Override
     ...
     */
    public int compareTo(TipoFormaCobro o) {
