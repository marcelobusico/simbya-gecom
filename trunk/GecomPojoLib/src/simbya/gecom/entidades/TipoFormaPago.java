...
/**
 * Clase de Entidad que representa una forma de pago.
 * @author Marcelo Busico.
 */
public class TipoFormaPago implements InterfazTipoGenerico<TipoFormaPago>, Normalizable {
    ...
    public TipoFormaPago(String nombre) {
        this.nombre = nombre;
    }

    public TipoFormaPago(String nombre, String descripcion) {
        this.nombre = nombre;
    ...
    /**
     * Muestra el nombre de la forma de pago.
     */
    @Override
     ...
     */
    public int compareTo(TipoFormaPago o) {
