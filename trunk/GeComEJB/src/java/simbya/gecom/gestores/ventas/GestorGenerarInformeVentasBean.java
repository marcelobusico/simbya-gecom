 ...
 */
@Stateful
public class GestorGenerarInformeVentasBean implements GestorGenerarInformeVentasRemote {
     ...
     */
    public List<Venta> getVentasDelPeriodo(Date fechaDesde, Date fechaHasta) {
        if (fechaDesde == null) {
