 ...
 */
@Remote
public interface GestorActualizarProductoRemote {
     ...
     */
    Producto confirmarActualizacion(boolean nuevo, Producto producto)
            throws RegistroFallidoException;

    void cargarImagen(byte[] data) throws IOException;

    byte[] getImagenProducto(Producto p) throws Exception;

    void bajaDeProducto(Producto p) throws Exception;
}
